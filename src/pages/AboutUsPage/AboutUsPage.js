...
function AboutUsPage() {
    return (
        <>
            ...
            <Row style={{marginRight:'0',marginLeft:'0',paddingTop:'5.5rem'}} className="bigRow">
          ...
          <section id="counter" class="counter">
            <div class="main_counter_area">
                <div class="p-y-3">
                    <div class="container">
                        <div class="row">
                            <div style={{display:'flex'}} class="main_counter_content text-center white-text wow fadeInUp">
                                <div class="col-md-4">
                                    <div class="single_counter p-y-2 m-t-1"> <i style={{fontSize:'3rem'}} class="fa fa-briefcase m-b-1"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="single_counter p-y-2 m-t-1"> <i style={{fontSize:'3rem'}} class="fa fa-check m-b-1"></i>
                                        <h2 class="statistic-counter">
                                ...
                                <div class="col-md-4">
                                    <div class="single_counter p-y-2 m-t-1"> <i style={{fontSize:'3rem'}} class="fa fa-coffee m-b-1"></i>
                                        <h2 class="statistic-counter">
