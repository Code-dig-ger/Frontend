          ...
          <div className="content-containeri">
            <div className="form-containeri">
              <form className="thisformi">
                <h3 className="headingi">Update Profile</h3>
                <h6 style={{ color: 'white' }}>
                  Fields marked with asteric are required.
                </h6>
                <h6 style={{ color: 'white' }}>
                  Fill only those fields you want to update.
                </h6>
                <br></br>
                ...
                <br></br>
                <input
                  placeholder={`Codeforces handle : ${codeforces}`}
                  onChange={(e) => setnewCodeforces(e.target.value)}
                  className="inputi"
                  type="text"
                  required
                />
                ...
                <input
                  placeholder={`Codechef handle : ${codechef}`}
                  onChange={(e) => setnewCodechef(e.target.value)}
                  className="inputi"
                  type="text"
                />
                <br></br>
                ...
                <input
                  placeholder={`Atcoder handle : ${atcoder}`}
                  onChange={(e) => setnewAtcoder(e.target.value)}
                  className="inputi"
                  type="text"
                />
                <br></br>
                ...
                <input
                  placeholder={`Spoj handle : ${spoj}`}
                  onChange={(e) => setnewSpoj(e.target.value)}
                  className="inputi"
                  type="text"
                />
                ...
                <br></br>
                <input
                  placeholder={`UVA handle : ${uv}`}
                  onChange={(e) => setnewUv(e.target.value)}
                  className="inputi"
                  type="text"
                />
                <br></br>
