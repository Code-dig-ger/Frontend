export async function getLists(accessToken, wise, type) {
  return fetch(`https://143.110.253.225/lists/${wise}/${type}/`, {
    method: 'GET',
    headers: {
...
export async function getThisList(accessToken, wise, type, slug) {
  return fetch(`https://143.110.253.225/lists/${wise}/${type}/${slug}`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
export async function getUserList(accessToken) {
  return fetch(`https://143.110.253.225/lists/userlist/`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
export async function addToUserList(accessToken, slug, prob_id, platform) {
  return fetch(`https://143.110.253.225/lists/userlist/add`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
export async function deleteUserlist(accessToken, slug) {
  return fetch(`https://143.110.253.225/lists/userlist/edit/${slug}`, {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
export async function createNewUserlist(
  ...
  return fetch(`https://143.110.253.225/lists/userlist/new`, {
    method: 'POST',
    headers: {
      'Content-type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
